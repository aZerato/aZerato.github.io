module.exports = StringHelper = (function() {
    ...
    StringHelper.prototype.removeUselessWordsFR = function(str) {
        ...
        while(!state){
            ...
            for(var i = 0; i < defaultWordsRemovalMapFR.length; i++)
            {
                str = str.replace(' ' + defaultWordsRemovalMapFR[i] + ' ', ' ');
            }
    ...
    StringHelper.prototype.removeUselessWordsEN = function(str) {
        ...
        while(!state){
            ...
            for(var i = 0; i < defaultWordsRemovalMapEN.length; i++)
            {
                str = str.replace(' ' + defaultWordsRemovalMapEN[i] + ' ', ' ');
            }
